...
const ACTIVITIES_CARDS: TopicCard[] = [
  {
    tags: ['อบรมพัฒนา', 'วิชาชีพครู', 'การเขียนแผน'],
    ...
    body: 'เข้าร่วมสัมมนาวิชาการและเวิร์กชอปการพัฒนาการสอนอย่างต่อเนื่อง เช่น อบรมการสร้างแผน Active Learning และการผลิตสื่อนวัตกรรมในยุคดิจิทัล',
  },
  {
    tags: ['กิจกรรมพัฒนาผู้เรียน', 'ค่ายวิชาการ', 'วิทยากร'],
    iconPath: 'M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z',
    title: 'กิจกรรมส่งเสริมและพัฒนาผู้เรียน',
    body: 'เป็นแกนนำจัดกิจกรรมค่ายวิทยาศาสตร์ ค่ายคุณธรรม และโครงการนันทนาการเพื่อเสริมสร้างทักษะชีวิต ความสามัคคี และกระบวนการกลุ่มให้แก่ผู้เรียน',
  },
  {
    tags: ['จิตอาสา', 'บำเพ็ญประโยชน์', 'ความร่วมมือ'],
    iconPath: 'M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z',
    title: 'โครงการจิตอาสาเพื่อสังคม',
    body: 'ร่วมพัฒนาโรงเรียนในพื้นที่ห่างไกล ทาสีอาคารเรียน ปรับปรุงห้องสมุด และจัดกิจกรรมนันทนาการให้กับเด็กๆ เพื่อสนับสนุนการพัฒนาสิ่งแวดล้อมที่เอื้อต่อการเรียนรู้',
  },
  {
    tags: ['นวัตกรรม', 'นำเสนอผลงาน', 'วิชาการ'],
    iconPath: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1-.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H7c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.04-.42 1.99-1.07 2.75z',
    title: 'นวัตกรรมและการเผยแพร่ผลงาน',
    body: 'สร้างสรรค์นวัตกรรมการสอนแบบเกมมิฟิเคชัน (Gamification) และเข้าร่วมประกวดผลงานนวัตกรรมทางการศึกษาในเวทีระดับมหาวิทยาลัย',
  },
];
