...
const SCHOOL_CARDS: TopicCard[] = [
  {
    tags: ['สุวรรณภูมิพิทยไพศาล', 'ส.ว.พ. (SWP)', 'ประวัติโรงเรียน'],
    iconPath: 'M12 2L1 21h22L12 2zm0 3.99L19.53 19H4.47L12 5.99zM13 16h-2v2h2v-2zm0-6h-2v4h2v-4z',
    title: 'ข้อมูลและประวัติโรงเรียนสุวรรณภูมิพิทยไพศาล',
    body: 'โรงเรียนสุวรรณภูมิพิทยไพศาล (ส.ว.พ. / SWP) ก่อตั้งขึ้นเมื่อ 29 มิถุนายน พ.ศ. 2515 ตั้งอยู่ ณ บ้านโพนสูง ตำบลสระคู อำเภอสุวรรณภูมิ จังหวัดร้อยเอ็ด เป็นโรงเรียนมัธยมศึกษาขนาดใหญ่พิเศษประจำอำเภอ สีประจำโรงเรียนคือ เขียว – ขาว',
  },
  {
    tags: ['วิสัยทัศน์ 2568', 'ปรัชญาโรงเรียน', 'คำขวัญ ส.ว.พ.'],
    ...
    title: 'ปรัชญา คำขวัญ และวิสัยทัศน์สถานศึกษา',
    body: 'ปรัชญา: "ปญฺญา โลกสฺมิ ปชฺโชโต" (ปัญญาคือแสงสว่างในโลก) | คำขวัญ: "เรียนเก่ง วินัยดี กีฬาเยี่ยม" | วิสัยทัศน์: เป็นองค์กรแห่งการเรียนรู้ มีความเป็นเลิศทางวิชาการ บนพื้นฐานของคุณธรรม บริหารจัดการด้วยระบบคุณภาพและสืบสานงานพระราชดำริ',
  },
  {
    tags: ['ผังโรงเรียน', 'อาคารสถานที่', 'แหล่งเรียนรู้'],
    iconPath: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.67-5.33-4-8-4z',
    title: 'สภาพแวดล้อมและผังอาคารสถานศึกษา',
    body: 'ผังบริเวณโรงเรียนประกอบด้วย อาคารเรียนมาตรฐาน กลุ่มอาคารวิทยาศาสตร์ ห้องปฏิบัติการคอมพิวเตอร์ อาคารโดมอเนกประสงค์ สนามกีฬา แปลงเกษตรการเรียนรู้ และพื้นที่บรรยากาศร่มรื่น เอื้อต่อการจัดกิจกรรมการเรียนรู้อย่างรอบด้าน',
  },
  {
    tags: ['บริบทนักเรียน', 'วิเคราะห์ผู้เรียน', 'ชุมชนสัมพันธ์'],
    ...
    title: 'บริบทนักเรียนและการมีส่วนร่วมกับชุมชน',
    body: 'นักเรียนมีความหลากหลายทางวัฒนธรรมและความถนัดเฉพาะบุคคล โรงเรียนมุ่งเน้นการเยี่ยมบ้าน ร่วมมือกับผู้ปกครองและชุมชนสระคู อำเภอสุวรรณภูมิ เพื่อส่งเสริมทักษะวิชาการ คุณธรรม จริยธรรม และทักษะชีวิตอย่างยั่งยืน',
  },
];
